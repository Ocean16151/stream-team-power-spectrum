...
def binning_bounds(bins, bin_size):
    ...
    """
    This function calculates the lower and upper bounds of bins given their midpoints and bin size.
...
def bin_data(phi_sim, bin_min, bin_max, number_of_bins):
    ...
    """
    This function counts how many values from the array phi_sim fall within each bin defined by 
...
def random_values(counts_phi, binning, bin_size):
    ...
    """
    This function generates a list of random angular values (in radians) distributed within bins.
